/* ============================================================
   FOLIOPUS ADMIN — script.js
   Modular SPA Logic · Static Auth · Clean Architecture
   ============================================================ */
...
function initLogout() {
  $('#btn-logout').addEventListener('click', () => {
    ...
    // Destroy charts to prevent canvas reuse error
...
function renderOverviewCharts() {
  ...
  // Template distribution doughnut
...
function renderSalesCharts() {
  ...
  const data   = [];
  for (let i = 29; i >= 0; i--) {
    const d = new Date(2026, 4, 4); // relative to dataset
